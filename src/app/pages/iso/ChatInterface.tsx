...
const renderMessage = (completedMessages: Set<string>, streamingMessageId: string | null, streamingWords: StreamingWord[], message: Message) => {
        ...
        <div key={message.id} className={cn("flex flex-col", message.type === "user" ? "items-end" : "items-start")}>
            <div
                className={cn(
                    ...
                    message.type === "user" ? "bg-gray-50 border border-gray-200 rounded-br-none" : "text-gray-50",
                )}
            >
                    ...
                    {messageSections.map((section, sectionIndex) => (
                        ...
                        >
                            {section.isNewSection && (
                                ...
                                >
                                    {section.messages.map((message) => renderMessage(completedMessages, streamingMessageId, streamingWords, message))}
                                </div>
                            )}

                            {!section.isNewSection && <div>{section.messages.map((message) => renderMessage(completedMessages, streamingMessageId, streamingWords, message))}</div>}
                        </div>
                    ))}
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 ">
                <form onSubmit={handleSubmit} className="max-w-3xl mx-auto">
                    <div
                        ...
                        className={cn(
                            "relative w-full rounded-3xl border border-gray-200 p-3 cursor-text bg-sidebar",
                    ...
                    >
                        <div className="pb-9">
                            <Textarea
                                ...
                                className="!bg-transparent shadow-none min-h-[24px] max-h-[160px] w-full rounded-3xl border-0 text-gray-50 placeholder:text-gray-200 placeholder:text-base focus-visible:ring-0 focus-visible:ring-offset-0 text-base pl-2 pr-4 pt-0 pb-0 resize-none overflow-y-auto leading-tight"
                                value={inputValue}
                                ...
                                <div className="flex items-center space-x-2">
                                    <Button
                                        ...
                                        className={cn(
                                            ...
                                            activeButton === "add" && "bg-gray-100 border-gray-900",
                                        )}
                                        onClick={() => toggleButton("add")}
                                        disabled={isStreaming}
                                    >
                                        <Plus className={cn("h-4 w-4 text-gray-700", activeButton === "add" && "text-gray-200")} />
                                    ...
                                    >
                                        ...
                                        <span className={cn("text-gray-300 text-sm", activeButton === "deepSearch" && "font-medium")}>
                                            DeepSearch
                                        </span>
                                    </Button>
                                    ...
                                    <Button
                                        ...
                                        className={cn(
                                            "rounded-full h-8 px-3 flex items-center border-gray-200 gap-1.5 transition-colors",
                                            activeButton === "think" && "bg-gray-100 border-gray-500",
                                        )}
                                        onClick={() => toggleButton("think")}
                                        disabled={isStreaming}
                                    >
                                        <Lightbulb className={cn("h-4 w-4 text-gray-500", activeButton === "think" && "text-gray-200")} />
                                        <span className={cn("text-gray-300 text-sm", activeButton === "think" && "font-medium")}>
                                            Think
                                        </span>
                                    </Button> */}
                                </div>
